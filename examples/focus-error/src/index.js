...
const App = () => (
  <Styles>
    ...
    <p>
      ...
      library as a pluggable 🏁 Final Form decorator to provide "focus on first
      error" functionality. Notice what when you click the Submit button, the
      focus is placed on the first field with an error.
    </p>
    <Form
      onSubmit={onSubmit}
